...
class _ShowListCardState extends State<ShowListCard> {
  ...
  Widget _buildFruitMobileCardContent({
    ...
    final Source? primarySource = (widget.isPlaying ? widget.playingSource : null) ??
    ...
    // Star rating
    final Source? targetSource = (widget.isPlaying ? widget.playingSource : null) ??
        (widget.show.sources.length == 1 ? widget.show.sources.firstOrNull : null);
    final String? ratingKey = targetSource?.id;
