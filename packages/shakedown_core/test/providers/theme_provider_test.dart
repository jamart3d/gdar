...
void main() {
  ...
  group('ThemeProvider toggleTheme tests', () {
    ...
    test('toggleTheme(Brightness.dark) should switch to light when system is dark', () async {
      final provider = ThemeProvider(isTv: false);
      // Ensure preferences are loaded
      await provider.initializationComplete;
      
      print('Mode index: ${provider.selectedThemeMode}');
    ...
    test('toggleTheme(Brightness.light) should switch to dark when system is light', () async {
      final provider = ThemeProvider(isTv: false);
      await provider.initializationComplete;
    ...
    test('toggleTheme() without brightness should use isDarkMode fallback', () async {
