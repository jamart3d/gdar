...
class MediaProjectionForegroundService : Service() {
    companion object {
        ...
        fun start(context: Context): Boolean {
            return try {
                ...
                Log.e(TAG, "Failed to request mediaProjection foreground service", t)
                markStartFailed()
                false
            }
        }
        ...
        fun stop(context: Context) {
            try {
                ...
                Log.w(TAG, "Failed to stop mediaProjection foreground service", t)
            }
        }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.i(
            TAG,
            "onStartCommand " +
                "(startId=$startId, action=${intent?.action}, sdk=${Build.VERSION.SDK_INT})",
        )
        try {
    ...
    private fun startCaptureForeground() {
        ...
        Log.i(TAG, "Foreground service ready")
        markForegroundReady()
    }
}
