...
(function () {
    ...
    class Track {
        ...
        onEnded(from) {
            ...
            // Guard: ignore if no longer the active track OR if this track's queue
            // is stale (e.g. setPlaylist rebuilt the queue while this track was decoding).
        ...
        init: function () {
            ...
            _queue = new Queue({
                ...
                onStartNewTrack: (track) => {
                    ...
                    // Publish the newly measured boundary gap immediately so
                    // HUD consumers opened mid-track do not miss the last LG.
                    _emitState(track);
                },
                onError: () => {
