...
## Medium Priority
- [ ] **Advanced Rating & Playback Logic:**
    - **Rating System:** Red Star (Block/Hide), 0 Stars (Unplayed), 1-3 Gold Stars.
    - **Random Logic:** Never pick Red Star. Prioritize Unplayed. Weighted randomness for stars (3>2>1).
    - **Settings:** Options for "Only Select Unplayed" and "Only Select High Rated (2-3 Stars)".
    - **Stats:** Track counts for Unplayed, Played, and Starred shows.
    - **UI Location:** Upper right corner of Show Card and Playback Controls.

- [ ] **Clipboard Details:** Tap SHNID badge on Playback Screen to copy show details (Venue, Date, SHNID) and Archive.org link to clipboard.
...
## Low Priority / Ideas
- [ ] **Favorites:** Allow users to mark certain shows as "favorites" for quick access.
