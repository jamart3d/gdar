---
name: Key File References
description: Where to find important context files in this repo
type: reference
---

| What | Path |
|---|---|
| Claude Code instructions | `CLAUDE.md` (repo root) |
| Jules/agent persona | `AGENTS.md` (repo root) |
| Agent workflows (save, jules, checkup, audit) | `.agent/workflows/` |
...
| Shared JS audio utilities | `apps/gdar_web/web/audio_utils.js` |
| Low-power detection (Dart) | `packages/shakedown_core/lib/utils/web_perf_hint.dart` |
| Web app entry point | `apps/gdar_web/lib/main.dart` |
